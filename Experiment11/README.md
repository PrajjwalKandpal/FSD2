...
![Customer Service](CUSTOMERSERVER.png)

### 2. Order Service Running
![Order Service](ORDERSERVER.png)

### 3. Test Order Service
![GET all Orders](TESTALL.png)

### 4. Update Order
![Update Status](UPDATE.png)

### 5. Verify update
![Verification](VERIFY.png)

### 6. Main Test
![Customer Service](MAINTESTCUSTSERVICE.png)

### 7. Error Case
![Error Found](ERRORCASE.png)
